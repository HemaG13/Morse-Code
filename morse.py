...
ap.add_argument("-p", "--shape-predictor", required=True,
	help=r"C:\xampp\htdocs\Morse_HTML\shape_predictor_68_face_landmarks.dat")
...
cur = con.cursor()
cur.execute("insert into words values(%s,%s,%s)",(date,time,string))
con.commit()
cur.close()
con.close()
...
class Widget():
    def __init__(self):
        ...
        self.label1 = tk.Label(self.root, text='Press the below button for voice!')
        self.label1.pack()
        #self.entry = tk.Entry(self.root)
        self.label2 = tk.Label(self.root, text='Your Word: '+ string)
        self.label2.pack()
        self.entry = string
        #self.entry.pack()
